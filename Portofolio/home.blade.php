    ...
    <body>
            ...
            <div class="main-container">
                <div class="nav">
                    ...
                    <nav>
                        <ul>
                            ...
                            <li><a href="#portfolios">Portofolios</a></li>
                ...
                <section id="hero">
                    <div class="hero-left">
                        ...
                        <h1 class="hero-name">Della <span>Yunia <span>Putri </span></span></h1>
                        <p>
                            I am a dedicated Computer Science student with a passion for exploring the intersections of technology and innovation.
                        </p>
                    </div>
        ...
        <section id="services">
            <div class="services main-container">
                ...
                <h1 class="section-title services-title">Specialized</h1>
                ...
                <div class="grid-3">
                    ...
                    <div class="service">
                        ...
                        <p>Standard designing, building, and implementing your apllications with documentation.</p>
                    </div>
                    <!-- Service  -->
                    <div class="service">
                        <div class="service-icon">
                        ...
                        <p>Create and maintain your website and also take care of its performance and traffic capacity.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="portofolios">
            <div class="portofolios main-container">
                <h3 class="pre-tittle">My Projects</h3>
                <h1 class="section-title">Featured Portofolios</h1>
            
                <div class="grid-3">
                    <!-- Portfolio 1 -->
                    <div class="portofolio">
                        <div class="portovolio-cover">
                            <img 
                                src="./images/portofolios/portofolio-1.png" 
                                alt="Portfolio 1"/>
                        </div>
                        ...
                        <div class="portofolio-info">
                            ...
                            <p>
                                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quia eligendi cupiditate asperiores nam, beatae repudiandae expedita fugit, quos dicta ut unde rerum vero repellat vitae.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="portofolio">
                        <div class="portovolio-cover">
                            <img 
                                src="./images/portofolios/portofolio-2.png" 
                                alt="Portfolio 2"/>
                        </div>
                    ...
                    <div class="portofolio">
                        <div class="portovolio-cover">
                            <img 
                                src="./images/portofolios/portofolio-3.png" 
                                alt="Portfolio 3"/>
                        </div>
                    ...
                    <div class="skills-left">
                        ...
                        <div class="education">
                            ...
                            <div class="education-info">
                                <h4 class="education-title">Binus University</h4>
                        ...
                        <div class="education">
                            ...
                            <div class="education-info">
                                <h4 class="education-title">SMAN 2 PARE</h4>
                                <p>Science Major</p>
                        ...
                        <div class="education">
                            ...
                            <div class="education-info">
                                <h4 class="education-title">SMPN 2 KANDANGAN</h4>
                                <p>-</p>
        ...
        <section id="contact">
            <div class="contact main-container">
                <div class="contact-left">
                    ...
                    <form class="contact-form" action="https://formspree.io/f/mzbnyveb" method="POST">
                        <div>
